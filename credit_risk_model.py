...
===================================================
Predicts probability that a borrower will experience serious delinquency
(90+ days past due) in the next 2 years, using Logistic Regression,
Decision Tree, and Random Forest classifiers.

Target column : SeriousDlqin2yrs (1 = defaulted / delinquent, 0 = good)
"""
...
# 1. LOAD DATA
# ----------------------------------------------------------------------
TRAIN_PATH = "cs-training.csv"   # change path if needed
TEST_PATH = "cs-test.csv"        # Kaggle test set has NO labels (used for submission only)
...
def engineer_features(data: pd.DataFrame) -> pd.DataFrame:
    ...
    # MonthlyIncome: impute with median (income is right-skewed)
    data["MonthlyIncome"] = data["MonthlyIncome"].fillna(data["MonthlyIncome"].median())
    # NumberOfDependents: missing usually means 0 dependents
    ...
    # Past-due columns have placeholder outlier values (96, 98) -> cap them
    ...
    # Cap extreme outliers in ratio-type columns (winsorize at 99th pct)
